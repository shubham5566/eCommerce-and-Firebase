            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                  ...
                  </Link>
                {
                  ...
                  {
                    user?.user?.email ==='varsha@gmail.com' ? <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Admin
                  </Link> :" "
                  }
                  {
                    user ? 
                    <a className="text-sm font-medium text-gray-700 cursor-pointer  " onClick={logout} style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Logout
                    </a>: ""
                  }
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  </Link>
                 {
                  ...
                  <div className="flow-root">
                    { user?.user?.email ==='varsha@gmail.com' ? <Link to={'/dashboard'} className="-m-2 block p-2 font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '', }}>
                      admin
                    </Link>: ""}
